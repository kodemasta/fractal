 ...
 */
public class MandelbrotQuarticFunction extends AbstractFractalFunction {

	/**
	 * Constructor
	 */
	public MandelbrotQuarticFunction() {
		FractalConfig config = new FractalConfig(-1.75, -1.75, 1.75, 1.75);
		fractalInfo = new FractalInfo(IteratedFunctionFactory.FractalType.MANDELBROT_QUARTIC, IteratedFunctionFactory.FractalType.NONE, "Mandelbrot Quartic Fractal", "Mandelbrot Quartic", config);
	}
