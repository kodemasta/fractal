 ...
 */
public class MandelbrotCubicJuliaFunction extends AbstractFractalFunction {

	/**
	 * Constructor
	 */
	public MandelbrotCubicJuliaFunction() {
		FractalConfig config = new FractalConfig(-1.75, -1.75, 1.75, 1.75);
		fractalInfo = new FractalInfo(IteratedFunctionFactory.FractalType.MANDELBROT_CUBIC_JULIA,
				IteratedFunctionFactory.FractalType.MANDELBROT_CUBIC,
				"Mandelbrot Cubic Julia Fractal",
				"Mandelbrot Cubic (Julia)", config);
	}
